...
def linearSVC():
    system('cls')
    print("You chose LinearSVC.\n")
    testModel(1)


def multinomialNB():
    system('cls')
    print("You chose MultinomialNB.\n")
    testModel(2)


def complementNB():
    system('cls')
    print("You chose ComplementNB.\n")
    testModel(3)


def bernoulliNB():
    system('cls')
    print("You chose BernoulliNB.\n")
    testModel(4)
...
def customYoutubeVideo():
    system('cls')
    print("You chose custom Youtube video.\n")
