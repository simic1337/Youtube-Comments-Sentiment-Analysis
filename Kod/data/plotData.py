...
def createBarChartAndPie(data):
    ...
    # create bar chart with sentiment on x axis and comments count on y axis
    # colors are green for positive, red for negative and yellow for neutral
    plt.figure(1)
    plt.subplot(1, 2, 1)
...
def createWordFrequencyWordCloud(data):
    ...
    plt.figure(2)
    # Interpolation is used to make the displayed image appear more smoothly
